...
const getCryptoNewsRouter_1 = __importDefault(require("./routes/getCryptoNewsRouter"));
const getCryptoExchangesRouter_1 = __importDefault(require("./routes/getCryptoExchangesRouter"));
dotenv.config();
